...
| **Deploy · A3** | **N2 auto-provision (OAuth + crear proyecto Firebase)** | ⚪ **DIFERIDO** — el tramo más pesado (va último). OAuth con Google + crear el proyecto Firebase/GCP en la cuenta del cliente vía API (el «full» de D3 que P3-1 difiere a v1.1). Rompe el patrón puramente-BYO-secret de A1/A2 → diseño aparte. |
