...
const es: Dict = {
  ...
  "preview.title": "App en vivo",
  "preview.subtitle": "Ve la app que se está construyendo, corriendo de verdad — efímera y descartable.",
  "preview.generate": "Generar preview",
  "preview.regenerate": "Regenerar",
  "preview.open": "Abrir en pestaña nueva ↗",
  "preview.refLabel": "Rama o sprint (opcional)",
  "preview.refPlaceholder": "rama por defecto del repo",
  "preview.status.pending": "En cola…",
  "preview.status.building": "Levantando la app (clona · migra · arranca)… puede tardar un par de minutos.",
  "preview.status.live": "En vivo",
  "preview.status.expired": "Expiró — generá una nueva.",
  "preview.status.failed": "Falló",
  "preview.expires": "Expira {when}",
  "preview.empty": "Todavía no generaste un preview de este proyecto.",
  "preview.emptyHint": "Levanta un contenedor efímero con la app corriendo end-to-end y te da un link público temporal.",
  "preview.disclaimer": "Preview descartable en infraestructura de Fluxo — no es el deploy a producción (eso es BYO a tu Vercel/Firebase). Se apaga solo al expirar.",
  "preview.readError": "No se pudo leer el estado del preview: {msg}",
  "preview.requestError": "No se pudo pedir el preview: {msg}",
};
...
const en: Dict = {
  ...
  "preview.title": "Live app",
  "preview.subtitle": "See the app being built, actually running — ephemeral and disposable.",
  "preview.generate": "Generate preview",
  "preview.regenerate": "Regenerate",
  "preview.open": "Open in new tab ↗",
  "preview.refLabel": "Branch or sprint (optional)",
  "preview.refPlaceholder": "repo default branch",
  "preview.status.pending": "Queued…",
  "preview.status.building": "Bringing the app up (clone · migrate · start)… this can take a couple of minutes.",
  "preview.status.live": "Live",
  "preview.status.expired": "Expired — generate a new one.",
  "preview.status.failed": "Failed",
  "preview.expires": "Expires {when}",
  "preview.empty": "You haven't generated a preview for this project yet.",
  "preview.emptyHint": "Spins up an ephemeral container with the app running end-to-end and gives you a temporary public link.",
  "preview.disclaimer": "Disposable preview on Fluxo infra — not the production deploy (that's BYO to your Vercel/Firebase). It shuts itself down on expiry.",
  "preview.readError": "Couldn't read preview status: {msg}",
  "preview.requestError": "Couldn't request the preview: {msg}",
};
