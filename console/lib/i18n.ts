...
const es: Dict = {
  ...
  "home.openBrain": "Abrir el brain explorer del proyecto de dev →",
  "home.configure": "Configurá NEXT_PUBLIC_DEV_PROJECT_ID y navegá a /brain/<project_id>.",
...
const en: Dict = {
  ...
  "home.openBrain": "Open the dev project's brain explorer →",
  "home.configure": "Set NEXT_PUBLIC_DEV_PROJECT_ID and go to /brain/<project_id>.",
